...
public class EarningsHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private RecycleViewItemCallBack mRecycleViewItemCallBack;
    private ArrayList<EarningsModel> list;
    ...
    public EarningsHistoryAdapter(Context mContext, ArrayList<EarningsModel> mList, RecycleViewItemCallBack mRecycleViewItemCallBack) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_earnings_layout, parent, false);
