...
public class OrderHistoryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public OrderHistoryAdapter(Context mContext, ArrayList<PendingOrderModel> mList, RecycleViewItemCallBack mRecycleViewItemCallBack) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_order_history_layout, parent, false);
...
//
        ...
        if(model.getType().equals("0")){
            viewHolder.typname.setText("Express");
